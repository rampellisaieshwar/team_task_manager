...
It also has strict role-based access control built right in. If you log in as an 'admin', you have the privileges to create and delete projects, as well as dynamically assign and delete tasks. On the other hand, regular 'member' users can focus solely on their assigned work and update their task statuses in real-time. Everything is organized logically, with tasks natively grouped under their respective project workspaces.
...
- Admin Role: alice.admin@example.com / alicepass
- Member Role: bob.builder@example.com / bobpass


Running Locally
---------------
If you'd like to spin this up on your local machine, it's very straightforward:

1. Ensure you have your `DATABASE_URL` set in a `.env` file in the root directory.
2. Activate your virtual environment and install the dependencies:
   $ pip install -r requirements.txt
3. Run the FastAPI server using uvicorn:
   $ uvicorn main:app --host 127.0.0.1 --port 8000
4. Open your web browser and navigate to http://127.0.0.1:8000 to see the app!
